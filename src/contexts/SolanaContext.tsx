...
// export interface SolanaContextData {
//   // solana: Solana;
...
// const YobotContext = createContext<SolanaContextData | undefined>(undefined);
...
//   const [solana, setYobot] = useState<Solana>(
//     () => new Solana(chooseBestWeb3Provider())
//   );
